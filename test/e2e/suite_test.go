// Package e2e contains the platform end-to-end test suite.
//
// These tests verify the TalosCluster bootstrap direct path, the ConductorReady
// condition gate, and port 50000 backoff behaviour on a live cluster.
//
