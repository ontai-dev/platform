...
// Lineage condition type and reason constants shared across all Platform CRD
// status condition sets. These values are defined by seam-core-schema.md §7
// Declaration 5 and are reserved platform-wide.
...
const (
	...
	//     This is a one-time initialization — the reconciler never writes this again.
	//  2. When InfrastructureLineageController is deployed and processes the root
	//     declaration, it takes ownership and sets it to True.
