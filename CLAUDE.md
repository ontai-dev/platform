...
CP-INV-004 -- (amended 2026-05-31, Governor directive) Admin or compiler creates seam-tenant-{cluster-name} namespaces. Platform no longer creates or owns these namespaces. Compiler generates namespace YAML as part of bootstrap/import output.
